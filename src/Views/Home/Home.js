        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-md-3 category-responsive">
                    <a href="#" className="category-wrap">
                        <div className="category-block">
                            <svg className="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 496 496" style="enable-background:new 0 0 496 496;" xml:space="preserve" width="512px" height="512px"><g><g>
              <g>
                <g>
                ...
                <div className="col-md-3 category-responsive">
                    <a href="#" className="category-wrap">
                        <div className="category-block">
                            <svg className="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 469.824 469.824" style="enable-background:new 0 0 469.824 469.824;" xml:space="preserve" width="512px"
                                height="512px"><g><g>
              <g>
              ...
              <g>
                ...
                <div className="col-md-3 category-responsive">
                    <a href="#" className="category-wrap">
                        <div className="category-block">
                            <svg className="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_2" x="0px" y="0px" viewBox="0 0 503.607 503.607" style="enable-background:new 0 0 503.607 503.607;" xml:space="preserve" width="512px"
              ...
              <g>
                ...
                <div className="col-md-3 category-responsive">
                    <a href="#" className="category-wrap">
                        <div className="category-block">
                            <svg className="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_3" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="512px" height="512px"><g><g>
              <g>
            ...
            <div className="row">
                <div className="col-md-3 category-responsive">
                    <a href="#" className="category-wrap">
                        <div className="category-block">
                            <svg className="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_2" x="0px" y="0px" viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;" xml:space="preserve" width="512px" height="512px"><g><g>
              ...
              <path d="M42,21c-2.206,0-4,1.794-4,4c0,0.553,0.448,1,1,1s1-0.447,1-1c0-1.103,0.897-2,2-2s2,0.897,2,2c0,0.553,0.448,1,1,1   s1-0.447,1-1C46,22.794,44.206,21,42,21z" data-original="#000000" className="active-path" data-old_color="#ff3a6d" fill="#ff3a6d"/>
                ...
                <div className="col-md-3 category-responsive">
                    <a href="#" className="category-wrap">
                        <div className="category-block">
                            <svg className="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_3" x="0px" y="0px" viewBox="0 0 511.988 511.988" style="enable-background:new 0 0 511.988 511.988;" xml:space="preserve" width="512px"
                                height="512px"><g><g>
              <g>
              ...
              <g>
                ...
                <div className="col-md-3 category-responsive">
                    <a href="#" className="category-wrap">
                        <div className="category-block">
                            <svg className="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_4" x="0px" y="0px" viewBox="0 0 33 33" style="enable-background:new 0 0 33 33;" xml:space="preserve" width="512px" height="512px"><g><g>
              <g>
              ...
              <path d="M23.698,11.765H7.361c-1.809,0-3.28-1.472-3.28-3.28s1.472-3.28,3.28-3.28h0.239C7.936,2.249,10.413,0,13.438,0   c1.795,0,3.482,0.819,4.596,2.213c0.487-0.207,0.993-0.312,1.508-0.312c1.952,0,3.586,1.417,3.909,3.303h0.247   c1.809,0,3.28,1.472,3.28,3.28S25.507,11.765,23.698,11.765z M7.361,6.204c-1.258,0-2.28,1.022-2.28,2.28s1.022,2.28,2.28,2.28   h16.337c1.258,0,2.28-1.022,2.28-2.28s-1.022-2.28-2.28-2.28h-0.693c-0.267,0-0.485-0.208-0.499-0.475   c-0.082-1.586-1.384-2.828-2.964-2.828c-0.485,0-0.964,0.128-1.423,0.38c-0.223,0.124-0.508,0.056-0.652-0.155   C16.554,1.795,15.048,1,13.438,1c-2.646,0-4.786,2.073-4.873,4.721c-0.009,0.27-0.23,0.483-0.5,0.483H7.361z" data-original="#000000" className="active-path" data-old_color="#ff3a6d" fill="#ff3a6d"/>
                ...
                <div className="col-md-3 category-responsive">
                    <a href="#" className="category-wrap">
                        <div className="category-block">
                            <svg className="category-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_5" x="0px" y="0px" viewBox="0 0 61.168 61.168" style="enable-background:new 0 0 61.168 61.168;" xml:space="preserve" width="512px"
                                height="512px"><g><g>
...
class ProductLargeTiles extends  Component{
    ...
    componentWillMount(){
        ...
        proxy.processRequest(ProductsEndpoints.getSummary(),false).then(response => {
    ...
    _getProductCount(name){

        const summary = this.state.summary;
        const f = summary.find(x => x.ProductType == name);
        if(f){
            return f.TotalCount;
        }
        ...
        return <section className="main-block">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-5">
                        <div className="styled-heading">
                            <h3 style={{fontSize: 27}}>{props.title}</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <div className="find-place-img_wrap">
                                    <div className="grid">
                                        <figure className="effect-ruby" onClick={() => history.push('/list?product=Insecticide') }>
                                            <img src="images/find-place1.jpg" className="img-fluid" alt="img13" />
                                            {summary && <figcaption>
                                                <h5>Insecticides</h5>
                                                <p>{this._getProductCount("Insecticide")} Available</p>
                                            </figcaption>}
                                        </figure>
                                    </div>
                                </div>
                            ...
                            <div className="col-md-4">
                                <div className="row find-img-align">
                                    <div className="col-md-12">
                                        <div className="find-place-img_wrap">
                                            <div className="grid">
                                                <figure className="effect-ruby" onClick={() => history.push('/list?product=Fungicide') }>
                                                    <img src="images/find-place2.jpg" className="img-fluid" alt="img13" />
                                                    {summary && <figcaption>
                                                        <h5>Fungicides</h5>
                                                        <p>{this._getProductCount("Fungicide")} Available</p>
                                                    </figcaption>}
                                                </figure>
                                            </div>
                                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="find-place-img_wrap">
                                            <div className="grid">
                                                <figure className="effect-ruby" onClick={() => history.push('/list?product=Weedicide') }>
                                                    <img src="images/find-place3.jpg" className="img-fluid" alt="img13" />
                                                    {summary && <figcaption>
                                                        <h5>Weedicide</h5>
                                                        <p>{this._getProductCount("Weedicide")} Available</p>
                                                    </figcaption>}
                                                </figure>
                                            </div>
                                        </div>
                            ...
                            <div className="col-md-4">
                                <div className="row find-img-align">
                                    <div className="col-md-12">
                                        <div className="find-place-img_wrap">
                                            <div className="grid">
                                                <figure className="effect-ruby" onClick={() => history.push('/list?product=Fertilizer') }>
                                                    <img src="images/find-place4.jpg" className="img-fluid" alt="img13" />
                                                    {summary && <figcaption>
                                                        <h5>Fertilizer </h5>
                                                        <p>{this._getProductCount("Fertilizer")} Available</p>
                                                    </figcaption>}
                                                </figure>
                                            </div>
                                        </div>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="find-place-img_wrap">
                                            <div className="grid">
                                                <figure className="effect-ruby" onClick={() => history.push('/list?product=Herbicide') }>
                                                    <img src="images/find-place5.jpg" className="img-fluid" alt="img13" />
                                                    {summary &&<figcaption>
                                                        <h5>Herbicides</h5>
                                                        <p>{this._getProductCount("Herbicide")} Available</p>
                                                    </figcaption>}
                                                </figure>
                                            </div>
                                        </div>
...
class  Home extends Component {
    ...
    render(){
        ...
        return  <DocumentTitle title="GIZ Platform">
                    <div>

                        <HeaderMenu/>

                        <Slider title={<span style={{color: "white" }}>Find input dealers in Ghana</span>}
                                hintMessage="Discover the right input dealers nearest to you."
                                searchInputHint="What product are you looking for?"
                                searchText="SEARCH"/>

                        <ProductLargeTiles title="What Product Are You Looking For?"/>
